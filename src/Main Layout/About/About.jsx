        ...
        <div>
            <div className="flex flex-col-reverse justify-center items-center md:p-20 gap-10">
                ...
                {/* <div className="flex-1 space-y-5">
                    <h1 className=" font-Roboto text-3xl md:text-6xl text-center my-5 lg:my-1 lg:text-left gradient">Hello and Welcome to <span className=" text-black">AssetWise Hub</span></h1>
                </div> */}
                <TypeAnimation
                    sequence={[
                        // Same substring at the start will only be typed out once, initially
                        'Hello and Welcome to AssetWiseHub',
                        1000, // wait 1s before replacing "Mice" with "Hamsters"
                        'Hello and Welcome to manage your assets',
                        1000,
                    ]}
                    wrapper="span"
                    speed={50}
                    style={{ fontSize: '3rem', display: 'inline-block', color: myHexColor, lineHeight: '2.25rem' }}
                    repeat={Infinity}
                />
            </div>
            <div>
