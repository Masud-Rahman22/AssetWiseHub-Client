...
const About = () => {
    return (
        <div>
            <div className="flex flex-col md:flex-col lg:flex-row justify-center items-center md:p-20">
                <div className='flex-1 my-5 md:my-1'>
                    <img className='w-[300px] h-[300px] md:w-[500px] md:h-[500px]' src={pic1} alt="" />
                </div>
                <div className="flex-1 space-y-5">
                    <h1 className="text-[#dbeeed] font-Roboto text-3xl md:text-6xl text-center my-5 lg:my-1 lg:text-left ">Hello and Welcome to <span className="text-[#ec5349]">AssetWise Hub</span>!</h1>
                </div>
            </div>
            <div>
                <h1 className="border-2 text-4xl shadow-md p-2 lg:w-1/6 text-center text-[#dbeeed] mx-auto mb-5 md:mb-1">About Us</h1>
                <div className="flex flex-col lg:flex-row-reverse items-center justify-center md:p-20">
                    <div className="mb-5 md:mb-1">
                        <img className='w-[300px] h-[300px] md:w-[600px] md:h-[650px]' src={pic2} alt="" />
                    </div>
